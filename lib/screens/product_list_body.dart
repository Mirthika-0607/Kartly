...
import './order_detail_screen.dart'; // Add this import for OrderDetailScreen
...
class _ProductListState extends State<ProductList> with SingleTickerProviderStateMixin {
          ...
          child: Card(
            ...
            child: Stack(
              children: [
                // Background image
                Positioned.fill(
                  child: _buildProductCardBackground(product),
                ),
  ...
  Widget _buildProductCardBackground(Product product) {
    if (product.productImage == null) {
      return Container(
        color: AppColors.beige,
        child: Center(
